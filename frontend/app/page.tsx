...
export default function Home() {
  ...
  return (
    <main className="min-h-[100dvh] p-4 md:p-8 flex flex-col items-center justify-center relative overflow-y-auto">
      ...
      <div className="w-full max-w-7xl relative z-10 flex flex-col min-h-[100dvh] lg:min-h-0 lg:h-[90vh] p-2 sm:p-4 lg:p-0">
        ...
        <div className="flex-1 flex flex-col lg:flex-row gap-4 lg:gap-6 min-h-0 pb-8 lg:pb-0">
          {/* Panel Izquierdo: Voz */}
          <section className="min-h-[400px] h-fit lg:h-full lg:w-1/2 shrink-0 lg:shrink">
            <VoicePanel sessionId={sessionId} />
          </section>

          {/* Panel Derecho: Texto */}
          <section className="h-[400px] lg:h-full lg:w-1/2 flex flex-col shrink-0 lg:shrink">
